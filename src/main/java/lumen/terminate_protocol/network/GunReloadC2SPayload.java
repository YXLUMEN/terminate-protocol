...
public record GunReloadC2SPayload() implements CustomPayload {
    public static final Identifier FIREARM_RELOAD_ID = Identifier.of(TerminateProtocol.MOD_ID, "gun_reload");
    public static final Id<GunReloadC2SPayload> ID = new Id<>(FIREARM_RELOAD_ID);
